...
IceUtil::PutQueueException::PutQueueException(const char* file, int line) :
    Exception(file, line)
{
}

const char* IceUtil::PutQueueException::_name = "IceUtil::PutQueueException";

string
IceUtil::PutQueueException::ice_name() const
{
    return _name;
}

IceUtil::Exception*
IceUtil::PutQueueException::ice_clone() const
{
    return new PutQueueException(*this);
}

void
IceUtil::PutQueueException::ice_throw() const
{
    throw *this;
}

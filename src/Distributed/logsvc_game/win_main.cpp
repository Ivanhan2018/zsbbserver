...
void read_xml_config(int & thread_pool, u_short & listen_port)
{
	...
	xmlreader::xmlnode * logsvc_node = config_node->get_child("logsvc_game");
...
int main(int argc, char* argv[])
{
	...
	try
	{
		...
		read_xml_config(thread_pool, listen_port);

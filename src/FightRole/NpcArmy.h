...
public:
	~NpcArmy(void);
public:
	bool Initialize(NpcArmyParam & armyParam , FightManager * fightManager, ENUM_USE_SCENE state ,  bool &isEnterSystem);
...
protected:
	EctypeNpcArmyTable* npcArmyTable_;
